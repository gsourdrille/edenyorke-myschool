...
class EtablissementDao{
	...
	public function updateEtablissement($etablissement){
		if($etablissement != null){
			$baseDao = new BaseDao();
			$baseDao->connect();
			$requete = "UPDATE ETABLISSEMENT SET NOM=$etablissement->nom, ADRESSE=$etablissement->adresse, CODE_POSTAL=$etablissement->codePostal,VILLE=$etablissement->ville,TELEPHONE_1=$etablissement->telephone1, TELEPHONE_2=$etablissement->telephone2,FAX=$etablissement->fax
