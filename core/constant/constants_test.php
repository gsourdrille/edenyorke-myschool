<?php
 ...
 class Constants{
 	...
 	const MAIL_VALID_URL_REPONSE="http://test.liveschool.fr/core/controller/valid_controller.php?token=";
 	const MAIL_DEMANDE_INCRIPTION="inscription@liveschool.fr";
